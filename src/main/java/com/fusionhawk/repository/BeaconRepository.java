...
public interface BeaconRepository extends JpaRepository<DemandTableRes, String> {
	...
	String fetchDemandTableByFG = "SELECT DISTINCT(Name) from Aurori where ForecastingGroup IN (:key)";
	//jatin
	//Fetch ForeCast On the basis of different filters
		String fetchForeCastOnFilter = "SELECT DISTINCT(ForecastingGroup) FROM Aurori WHERE ForecastingGroup!='' AND (Brand REGEXP :regexp AND (Sub_Brand REGEXP (:subBrand) "
				+ " REGEXP Alcohol_Percentage IN (:alcoholPerc) REGEXP UnitPerPack IN (:unitPerPack))";
		
		
	String fetchForecastingGroups_Updated_string = "SELECT DISTINCT(Name) from Aurori (:mainQuery)";
		
	
		
	// Fetch brands
	@Query(value = "SELECT DISTINCT(Brand) FROM Aurori WHERE Brand!=''", nativeQuery = true)
	List<String> fetchBrands();
	
	
	@Query(value = "SELECT DISTINCT(Brand) FROM Aurori WHERE Brand!='' AND ForecastingGroup IN (:forecastingGroupList)", nativeQuery = true)
	List<String> fetchBrands_filters(@Param("forecastingGroupList") List<String> forecastingGroupList);

	// Fetch plants
	@Query(value = "SELECT DISTINCT(plant) FROM Aurori WHERE plant!=''", nativeQuery = true)
	List<String> fetchPlants();
	
	
	@Query(value = "SELECT DISTINCT(unitPerPack) As unitPerPack FROM Aurori WHERE unitPerPack!=''", nativeQuery = true)
	List<String> fetchunitPerPack();
	
	
	
	@Query(value = "SELECT DISTINCT(Alcohol_percentage) As Alcohol_percentage FROM Aurori WHERE Alcohol_percentage!=''", nativeQuery = true)
	...
	@Query(value = "SELECT DISTINCT(Sub_Brand) As Sub_Brand FROM Aurori WHERE Sub_Brand!='' LIMIT 6", nativeQuery = true)
	List<String> fetchsubbrand();
	
	

	// Fetch CPGs
	@Query(value = "SELECT DISTINCT(customer_planning_group) FROM Aurori WHERE customer_planning_group!=''", nativeQuery = true)
	List<String> fetchCPGs();

	// Fetch Forecasting Groups
	@Query(value = "SELECT DISTINCT(ForecastingGroup) FROM Aurori WHERE ForecastingGroup!=''", nativeQuery = true)
	List<String> fetchForecastingGroups();

	@Query(value = "SELECT DISTINCT(ForecastingGroup) FROM Aurori WHERE ForecastingGroup!='' AND Brand REGEXP :regexp", nativeQuery = true)
	...
	@Query(value = "SELECT DISTINCT(ForecastingGroup) FROM Aurori WHERE ForecastingGroup!='' AND Alcohol_Percentage REGEXP :regexp", nativeQuery = true)
	...
	@Query(value = "SELECT DISTINCT(ForecastingGroup) FROM Aurori WHERE ForecastingGroup!='' AND Sub_Brand REGEXP :regexp", nativeQuery = true)
	List<String> fetchForecastingGroups_b(@Param("regexp") String regexp);
	
	
	
	
	@Query(value = "SELECT DISTINCT(ForecastingGroup) FROM Aurori WHERE ForecastingGroup!='' AND UnitPerPack REGEXP :regexp", nativeQuery = true)
	...
	@Query(value = "SELECT DISTINCT(ForecastingGroup) FROM Aurori WHERE ForecastingGroup!='' AND UnitPerPack REGEXP :regexp AND Alcohol_Percentage REGEXP :regexp1 ", nativeQuery = true)
	...
	@Query(value = "SELECT DISTINCT(ForecastingGroup) FROM Aurori WHERE ForecastingGroup!='' AND Sub_Brand REGEXP :regexp AND Alcohol_Percentage REGEXP :regexp1 ", nativeQuery = true)
	...
	@Query(value = "SELECT DISTINCT(ForecastingGroup) FROM Aurori WHERE ForecastingGroup!='' AND Sub_Brand REGEXP :regexp AND UnitPerPack REGEXP :regexp1 ", nativeQuery = true)
	...
	@Query(value = "SELECT DISTINCT(ForecastingGroup) FROM Aurori WHERE ForecastingGroup!='' AND Brand REGEXP :regexp AND UnitPerPack REGEXP :regexp1 ", nativeQuery = true)
	List<String> fetchForecastingGroups_ac(@Param("regexp") String regexp,@Param("regexp1") String regexp1);
	
	
	
	
	@Query(value = "SELECT DISTINCT(ForecastingGroup) FROM Aurori WHERE ForecastingGroup!='' AND Brand REGEXP :regexp AND Alcohol_Percentage REGEXP :regexp1 ", nativeQuery = true)
	List<String> fetchForecastingGroups_ad(@Param("regexp") String regexp,@Param("regexp1") String regexp1);
	
	
	
	
	@Query(value = "SELECT DISTINCT(ForecastingGroup) FROM Aurori WHERE ForecastingGroup!='' AND Brand REGEXP :regexp AND Sub_Brand REGEXP :regexp1 ", nativeQuery = true)
	List<String> fetchForecastingGroups_ab(@Param("regexp") String regexp,@Param("regexp1") String regexp1);
	
	
	
	
	@Query(value = "SELECT DISTINCT(ForecastingGroup) FROM Aurori WHERE ForecastingGroup!='' AND Sub_Brand REGEXP :subbrand AND UnitPerPack REGEXP :subbrand1 AND Alcohol_Percentage REGEXP :subbrand2 ", nativeQuery = true)
	...
	@Query(value = "SELECT DISTINCT(ForecastingGroup) FROM Aurori WHERE ForecastingGroup!='' AND Brand REGEXP :subbrand AND UnitPerPack REGEXP :subbrand1 AND Alcohol_Percentage REGEXP :subbrand2 ", nativeQuery = true)
	...
	@Query(value = "SELECT DISTINCT(ForecastingGroup) FROM Aurori WHERE ForecastingGroup!='' AND Brand REGEXP :subbrand AND Sub_Brand REGEXP :subbrand1 AND Alcohol_Percentage REGEXP :subbrand2 ", nativeQuery = true)
	...
	@Query(value = "SELECT DISTINCT(ForecastingGroup) FROM Aurori WHERE ForecastingGroup!='' AND Brand REGEXP :subbrand AND Sub_Brand REGEXP :subbrand1 AND UnitPerPack REGEXP :subbrand2 ", nativeQuery = true)
	...
	@Query(value = "SELECT DISTINCT(ForecastingGroup) FROM Aurori WHERE ForecastingGroup!='' AND Brand REGEXP :subbrand AND Sub_Brand REGEXP :subbrand1 AND UnitPerPack REGEXP :subbrand2 AND Alcohol_Percentage REGEXP :subbrand3", nativeQuery = true)
	...
	// Fetch filters lists
	@Query(value = "SELECT DISTINCT(customer_planning_group) FROM Aurori WHERE customer_planning_group!='' ORDER BY customer_planning_group", nativeQuery = true)
	List<String> fetchFilterListCPG();
 
	@Query(value = "SELECT DISTINCT(plant) FROM Aurori WHERE plant!='' ORDER BY plant;", nativeQuery = true)
	List<String> fetchFilterListPlants();
	


	@Query(value = "SELECT DISTINCT(pack_type_name) FROM Aurori WHERE pack_type_name!=''", nativeQuery = true)
...
//	
	// Fetch graphs
	@Query(value = "SELECT DISTINCT(lead_sku_name) FROM Aurori WHERE lead_sku_name!=''", nativeQuery = true)
